...
def create_app() -> FastAPI:
    ...
    # --- Routes ---
    from app.api.v1.endpoints import health, agents, conversations, knowledge, tools, analytics, memories, human_tasks, auth, workflow, monitoring, public, models, ai_employees, audit, channels, tool_approvals, resource_shares
    ...
    app.include_router(tool_approvals.router, prefix="/api/v1/tool-approvals", tags=["tool-approvals"])
    app.include_router(resource_shares.router, prefix="/api/v1/resources", tags=["resource-shares"])
