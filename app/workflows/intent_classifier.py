...
class IntentClassifier:
    ...
    INTENT_DEFINITIONS = {
        ...
        "knowledge_search": "顾客要求查找资料、图片、视频、文档、PPT等知识素材，或询问知识库中有什么内容",
        "image_generation": "顾客要求 AI 生成图片、画图、制作宣传图、生成产品场景图、根据文字描述创作图像",
        "video_generation": "顾客要求 AI 生成视频、制作视频/短片/宣传片、根据文字描述或图片创作动态视频内容（注意与'生成图片'区分）",
    ...
    KEYWORD_RULES = [
        ...
        (["查找资料", "找图片", "找视频", "找文档", "素材", "知识库", "资料库",
          "宣传图", "产品图", "视频介绍", "PPT", "幻灯片", "search knowledge"], "knowledge_search"),
        (["生成图片", "生成图", "画图", "画一张", "制作图片", "创作图片", "AI生图",
          "生成宣传图", "生成场景图", "生成一张", "给我画", "生成图像", "image generation",
          "generate image", "draw a", "create an image"], "image_generation"),
        (["生成视频", "生成一段视频", "生成一段", "制作视频", "做个视频", "做一段视频",
          "来一段视频", "一段视频", "生成短片", "制作短片", "创作视频", "AI生视频",
          "生成宣传片", "制作宣传片", "生成宣传视频", "制作宣传视频", "宣传视频生成",
          "视频生成", "图生视频", "video generation", "generate video", "create a video",
          "make a video", "text-to-video", "image-to-video"], "video_generation"),
...
4. confidence 表示你对分类的把握：只要消息能明确归入某个类别（即使内容简单），confidence 应给 0.8 以上；只有在多个类别之间确实难以判断时才给 0.5-0.8；低于 0.5 仅用于完全看不懂消息的情况
